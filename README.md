![List Diary Logo](https://github.com/RMartinPer/List-Diary/blob/master/app/src/main/res/mipmap-xxhdpi/ic_launcher_round.png)

# List Diary ![API](https://img.shields.io/badge/API-15%2B-brightgreen.svg?style=flat) [![License: GPL v3](https://img.shields.io/badge/License-GPLv3-orange.svg)](https://www.gnu.org/licenses/gpl-3.0) [![Release](https://img.shields.io/github/release/RMartinPer/List-Diary.svg)](https://github.com/RMartinPer/List-Diary/releases) [![Platform](https://img.shields.io/badge/platform-android-lightgrey.svg)](https://img.shields.io/badge/platform-android-lightgrey.svg) [![Code](https://img.shields.io/badge/code-java-yellow.svg)](https://www.java.com/en/)

Android application of management of lists with definable fields and of tasks with a record where to record its chosen changes.

## Screenshots

### Splash Screen

#### With the storage permission granted

![Screenshot 1](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/splashScreen.png)

#### With the storage permission denied

![Screenshot 2](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/splashScreenPermissionDialog.png)

### Main Screen

#### With a list without tasks

![Screenshot 3](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/mainScreenWithoutTasks.png)

#### With a list with tasks

![Screenshot 4](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/mainScreenWithTasks.png)

#### With the menu of additional actions of the list

![Screenshot 5](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/mainScreenOverflowDisplayed.png)

#### With the search view expanded

![Screenshot 6](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/mainScreenSearchExpanded.png)

#### With the navigation drawer displayed

![Screenshot 7](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/mainScreenDrawerDisplayed.png)

#### With the settings dialog

![Screenshot 8](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/mainScreenSettingsDialog.png)

#### With the data export dialog

![Screenshot 9](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/mainScreenExportDialog.png)

#### With the data import dialog

![Screenshot 10](https://github.com/RMartinPer/List-Diary/blob/master/screenshots/mainScreenImportDialog.png)
