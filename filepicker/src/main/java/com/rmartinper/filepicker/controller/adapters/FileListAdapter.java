...
public class FileListAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(MarkedItemList.hasItem(item.getLocation())) {
            animation = AnimationUtils.loadAnimation(context, R.anim.marked_item_animation);
        } else {
            animation = AnimationUtils.loadAnimation(context, R.anim.unmarked_item_animation);
        }
